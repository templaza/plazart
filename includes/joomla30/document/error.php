...
class JDocumentError extends JDocument
{
	...
	public function render($cache = false, $params = array())
	{
        ...
        $nameTemplate   = $getTemplate -> template;

        // Check file Child template
        $nameFileEr = $fileOvClf.$file;
        $pathFileEr = $directory . '/' . $nameTemplate. '/' .$nameFileEr;

        if(is_file($pathFileEr)) {
            // Load
            $data = $this->_loadTemplate($directory . '/' . $template, $nameFileEr);
        }else {
            // Load
