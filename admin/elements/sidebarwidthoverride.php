...
class JFormFieldSidebarWidthOverride extends JFormField
{
	...
	protected function getInput() {		
		...
		$html .= '<div class="label">' . JText::_('TPL_TZ_LANG_ADD_RULE_ITEMID_OPTION') . '</div>';
		$html .= '<input type="text" id="sidebar_width_for_pages_input" />';
		$html .= '<div class="label">' . JText::_('TPL_TZ_LANG_ADD_RULE_WIDTH') . '</div>';
		$html .= '<input type="text" value="" id="sidebar_width_for_pages_select" /><span class="unit">%</span>';
		$html .= '<input type="button" value="'.JText::_('TPL_TZ_LANG_ADD_RULE').'" id="sidebar_width_for_pages_add_btn" />';
