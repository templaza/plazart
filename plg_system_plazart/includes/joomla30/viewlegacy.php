...
class JViewLegacy extends JObject
{
    ...
    public function loadTemplate($tpl = null)
    {
        ...
        $fileNameOver   = $fileOvClf.$filetofind;
        $fileRootOver   = JPath::find($this->_path['template'], $fileNameOver);

        if($fileRootOver) {
            $this->_template = $fileRootOver;
        }else {
    ...
    protected function _setPath($type, $path)
    {
        ...
        switch (strtolower($type))
        {
            case 'template':
                ...
                if (isset($app))
                {
                    //if it is Plazart template, update search path for template
                    $this->_addPath('template', PLAZART_PATH.'/html/' . $component . '/' . $this->getName());
